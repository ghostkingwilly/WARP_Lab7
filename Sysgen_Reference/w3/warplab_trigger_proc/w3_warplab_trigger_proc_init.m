...
%                    Bit 29 is used as a HW / SW select
%       1 - Energy Detection
...
% 
if (simulation)
    TRIG_IN_CONF_0 = hex2dec('80000000');    % HW path is selected
    TRIG_IN_CONF_1 = hex2dec('80000000');
    TRIG_IN_CONF_2 = hex2dec('80000000');
    TRIG_IN_CONF_3 = hex2dec('80000000');
    TRIG_IN_CONF_4 = hex2dec('00000000');    % Enable Input pin 0; No debounce; No delay
    ...
    TRIG_IN_CONF_8 = hex2dec('80000000');    % HW path is selected
else
    TRIG_IN_CONF_0 = hex2dec('80000000');    % HW path is selected
    TRIG_IN_CONF_1 = hex2dec('80000000');
    TRIG_IN_CONF_2 = hex2dec('80000000');
...
%       CONF_1:
%           [31]    - Disable
%           [30]    - Bypass trigger output pulse extender
%           [29:16] - Reserved
%           [15: 0] - Output Delay
...
% 
if (simulation)
    TRIG_OUT_5_CONF_0 = hex2dec('00000000');
    TRIG_OUT_5_CONF_1 = hex2dec('80000000');

    TRIG_OUT_4_CONF_0 = hex2dec('00000000');
    TRIG_OUT_4_CONF_1 = hex2dec('80000000');

    TRIG_OUT_3_CONF_0 = hex2dec('00000000');
    TRIG_OUT_3_CONF_1 = hex2dec('80000000');

    TRIG_OUT_2_CONF_0 = hex2dec('00100000');    % Enable output based on trigger input pin 0; No delay
    TRIG_OUT_2_CONF_1 = hex2dec('00000000');

    TRIG_OUT_1_CONF_0 = hex2dec('00000000');
    TRIG_OUT_1_CONF_1 = hex2dec('80000000');

    TRIG_OUT_0_CONF_0 = hex2dec('00000000');
    ...
    TRIG_OUT_2_CONF_0 = hex2dec('00000000');
...
%
if (simulation)
    RSSI_PKT_DET_CONFIG = hex2dec('00000000');
else
    RSSI_PKT_DET_CONFIG = hex2dec('00000000');
end
...
%
if (simulation)
    RSSI_PKT_DET_THRESHOLDS = hex2dec('00000000');
else
    RSSI_PKT_DET_THRESHOLDS = hex2dec('00000000');
end
...
% 
if (simulation)
    RSSI_PKT_DET_DURATIONS = hex2dec('00000000');
else
    RSSI_PKT_DET_DURATIONS = hex2dec('00000000');
end
...
%
if (simulation)
    PKT_OPS_0      = hex2dec('00000000');
    PKT_TEMPLATE_0 = hex2dec('00000000');

    PKT_OPS_1      = hex2dec('00000000');
    PKT_TEMPLATE_1 = hex2dec('00000000');
else
    PKT_OPS_0      = hex2dec('00000000');
    PKT_TEMPLATE_0 = hex2dec('00000000');
